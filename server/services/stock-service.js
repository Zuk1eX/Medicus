...
class StockService {
    ...
    async stocksFilterFinallyTest(
        ...
        // console.log(stocksEntry, pipeline);
        // let stocks = stocksEntry;
        let resultsFacet = [];
        //     .append({
        //         $project: {
        //             resultsRoot: { $setUnion: ["$results"] },
        ...
        if (sort === "location" && 0) {
            ...
            resultsFacet.push({ $skip: offset }, { $limit: limit });
            // stocks = stocks.append({
            //     $geoNear: {
            //         near: {
            //             type: "Point",
            //             coordinates: [
            //                 37.864679365512586, 55.68642719732848,
            //             ],
            //         },
            //         key: "location",
            //         distanceField: "dist.calculated",
