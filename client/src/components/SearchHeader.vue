<template>
    <header class="header" ref="header">
        <div class="container search-container">
            <router-link :to="{ name: 'main' }" class="search__logo">
            ...
            <div class="search-btns">
                <button class="search__btn favourite__btn">
...
export default {
    ...
    methods: {
        ...mapMutations(["searchOverlayDisable", "searchOverlayEnable", "changeSearchText"]),
